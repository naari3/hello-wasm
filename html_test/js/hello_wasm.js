...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'hello_wasm.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'hello_wasm.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'hello_wasm.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "hello_wasm.js.mem" : null;
